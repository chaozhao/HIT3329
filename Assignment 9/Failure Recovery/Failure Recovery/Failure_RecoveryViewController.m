...
{
    downloadStatus = NO;
    NSString *downloadPath = [[NSHomeDirectory() stringByAppendingPathComponent:@"Documents"]stringByAppendingPathComponent:@"1.zip"];
    NSString *temporaryPath = [[NSHomeDirectory()stringByAppendingPathComponent:@"Documents"]stringByAppendingPathComponent:@"1.download"];
    ...
    [_request setDownloadDestinationPath:downloadPath];
    [_request setTemporaryFileDownloadPath:temporaryPath];
